...
{
    public class HttpResponse : HttpEntityHeader
    {
        #region Response Header
        public string Age
        {
            get => Header.TryGetValue("Age", out object value) ? value.ToString() : string.Empty;
            set => Header["Age"] = value;
        }
        public string KeepAlive
        {
            get => Header.TryGetValue("Keep-Alive", out object value) ? value.ToString() : string.Empty;
            set => Header["Keep-Alive"] = value;
        }
        public string Location
        {
            get => Header.TryGetValue("Location", out object value) ? value.ToString() : string.Empty;
            set => Header["Location"] = value;
        }
        public string ProxyAuthenticate
        {
            get => Header.TryGetValue("Proxy-Authenticate", out object value) ? value.ToString() : string.Empty;
            set => Header["Proxy-Authenticate"] = value;
        }
        public string Public
        {
            get => Header.TryGetValue("Public", out object value) ? value.ToString() : string.Empty;
            set => Header["Public"] = value;
        }
        public string RetryAfter
        {
            get => Header.TryGetValue("Retry-After", out object value) ? value.ToString() : string.Empty;
            set => Header["Retry-After"] = value;
        }
        /* Unofficial Heder */
        public string SecWebSocketAccept
        {
            get => Header.TryGetValue("Sec-WebSocket-Accept", out object value) ? value.ToString() : string.Empty;
            set => Header["Sec-WebSocket-Accept"] = value;
        }
        /* Unofficial Heder */
        public string SetCookie
        {
            get => Header.TryGetValue("Set-Cookie", out object value) ? value.ToString() : string.Empty;
            set => Header["Set-Cookie"] = value;
        }
        public string Server
        {
            get => Header.TryGetValue("Server", out object value) ? value.ToString() : string.Empty;
            set => Header["Server"] = value;
        }
        public string Vary
        {
            get => Header.TryGetValue("Vary", out object value) ? value.ToString() : string.Empty;
            set => Header["Vary"] = value;
        }
        public string Warning
        {
            get => Header.TryGetValue("Warning", out object value) ? value.ToString() : string.Empty;
            set => Header["Warning"] = value;
        }
        public string WWWAuthenticate
        {
            get => Header.TryGetValue("WWW-Authenticate", out object value) ? value.ToString() : string.Empty;
        ...
        public void Send(Stream value)
        {
            ...
            Content = value;
            ContentLength = value.Length.ToString();
        }
        public void Send(string value, Encoding encoding = null)
        {
            if (encoding == null) encoding = Encoding.UTF8;
            Send(new MemoryStream(encoding.GetBytes(value)));
        ...
        public override string ToString()
        {
            ...
            foreach (var attribute in Header)
                temp.Append($"{attribute.Key}:{attribute.Value.ToString()}\r\n");
            temp.Append("\r\n");
            return temp.ToString();
        }
        private static string Mapping(string extension)
        {
            switch (extension.ToLower())
            {
                ...
                case ".svg": return "application/xml";
